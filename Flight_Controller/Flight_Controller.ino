...
void setup(){
  ...
  while(receiver_input_channel_3 < 990 || receiver_input_channel_3 > 1030 || receiver_input_channel_4 < 1480){
...
void loop(){
  ...
  if(start == 1 && receiver_input_channel_3 < 1050 && receiver_input_channel_4 > 1480){
    start = 2;
