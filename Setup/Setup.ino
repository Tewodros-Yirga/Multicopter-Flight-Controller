...
void loop(){
  ...
  if(error == 0){
    ...
    for (cal_int = 0; cal_int < 5000 ; cal_int ++){              //Take 2000 readings for calibration.
    ...
    gyro_roll_cal /= 5000;                                       //Divide the roll total by 2000.
    gyro_pitch_cal /= 5000;                                      //Divide the pitch total by 2000.
    gyro_yaw_cal /= 5000;                                        //Divide the yaw total by 2000.
  ...
  if(error == 0){
    ...
    Serial.println(F("You can now calibrate the esc's and upload the flight controller code."));
  }
  else{
